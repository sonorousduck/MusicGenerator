...
def prepare_sequences(notes, n_vocab):
    ...
    for i in (0, len(notes) - sequence_length, 1):
...
def generate_notes(model, network_input, pitchnames, n_vocab):
    ...
    # Start somewhere random in the sequence
    ...
    for note_index in range(500):
        ...
        prediction_input = prediction_input / float(n_vocab)  # Normalizes the input

        prediction = model.prediction(prediction_input, verbose=0)
